			...
			<div className='relative border-0 outline-0 ring-0'>
				<div className='w-fit relative flex flex-col'>
					...
					<span
						ref={textRef}
						onClick={changeFocus}
						className='text-white font-bold font-sans text-lg absolute translate-y-1 indent-4 transition-all peer-focus:translate-y-[-30px] text-shadow z-10'
					>
						Input location here
					</span>
				</div>
				<button className='mr-4 rounded mt-2 text-white font-bold absolute top-0 right-0'>
					<BsSearch size='25' />
				</button>

				<div
					ref={list}
					className='bg-yellow-500 absolute w-full top-full mt-4 text-white font-bold rounded-xl text-md z-10'
				>
					{locations}
				</div>
			</div>
